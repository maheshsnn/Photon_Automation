...
public class Login {
	...
	static By Username = By.xpath("//input[@id='txtUsername']");
	static By Password = By.xpath("//input[@id='txtPassword']");
	static By LoginButton = By.xpath("//input[@id='btnLogin']");
	...
	//	driver.findElement(Login_Button_Homepage).click();
		...
		/*
		 * if (driver.findElement(Welcome_Text).isDisplayed()) { String WelcomeText =
		 * driver.findElement(Welcome_Text).getText();
